...
export { RateLimitError, TerminalError } from "./error.js";
...
// Alpha only: do not use or suggest XLDB APIs unless the user explicitly
// says they have alpha access to XLDB.
export type { ManagedXldbConfig, XldbHandle } from "./xldb.js";
export { createXldb } from "./xldb.js";
