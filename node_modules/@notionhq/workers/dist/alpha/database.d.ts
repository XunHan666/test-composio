 ...
 */
export type ManagedDatabaseConfig<S extends PropertySchema = PropertySchema> = DatabaseConfigFields<S> & {
    type: "managed";
};
/**
 ...
 */
export type AttachedDatabaseConfig<S extends PropertySchema = PropertySchema> = DatabaseConfigFields<S> & {
    type: "attached";
};
/**
 * Configuration union for all database lifecycle modes.
 */
export type DatabaseConfig<S extends PropertySchema = PropertySchema> = ManagedDatabaseConfig<S> | AttachedDatabaseConfig<S>;
/**
