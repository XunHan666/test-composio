...
import type { Cover, HandlerOptions, Icon, PeopleValue, PlaceValue, RelationValue, Schedule, TextValue } from "../types.js";
 ...
 * says they have alpha access to XLDB.
 */
export type XldbSyncExecutionResult<Schema extends XldbSchema, UpsertKey extends XldbUpsertKey<Schema>, State = unknown> = {
 ...
 */
export type SyncConfiguration<PK extends string, S extends Schema<PK>, State = unknown> = SharedSyncConfiguration<State, SyncExecutionResult<PK, State>> & {
 ...
 */
export type XldbSyncConfiguration<Schema extends XldbSchema, UpsertKey extends XldbUpsertKey<Schema>, State = unknown> = SharedSyncConfiguration<State, XldbSyncExecutionResult<Schema, UpsertKey, State>> & {
 ...
 * says they have alpha access to XLDB.
 */
export declare function createXldbSyncCapability<Schema extends XldbSchema, UpsertKey extends XldbUpsertKey<Schema>, State = unknown>(key: string, syncConfiguration: XldbSyncConfiguration<Schema, UpsertKey, State>, pacerDeclarations?: readonly PacerDeclaration[]): {
    _tag: "sync";
    key: string;
    config: {
        target: {
    ...
    handler(runtimeContext?: StatefulRuntimeContext<State>, options?: HandlerOptions): Promise<{
        changes: XldbSyncChange<Schema, UpsertKey>[];
        hasMore: boolean;
        nextUserContext: State | undefined;
        nextPacerStates: Record<string, import("../pacer_internal.js").PacerEntry>;
    }>;
};
export {};
